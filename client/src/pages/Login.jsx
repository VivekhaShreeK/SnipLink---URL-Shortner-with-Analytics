  ...
  return (
    <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center px-4 py-12">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -right-40 w-80 h-80 rounded-full bg-brand-500/10 dark:bg-brand-500/5 blur-3xl" />
      ...
      <div className="relative w-full max-w-md">
        <div className="glass-card p-8 animate-scale-in">
          ...
          {/* Google Sign-In Button — placed first like professional sites */}
          <button
            type="button"
          ...
          <div className="relative mb-5">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-3 bg-white dark:bg-surface-900 text-surface-400 dark:text-surface-500">or sign in with email</span>
            </div>
          </div>
